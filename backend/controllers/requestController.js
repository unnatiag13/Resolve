...
export async function createRequest(req, res, next) {
  try {
    ...
    res.status(201).json({
      ...
      data: {
        id: requestId,
        requesterName: newRequest['Requester Name'],
        requesterEmail: newRequest['Requester Email'],
        ...
        slaHours: newRequest['SLA Hours'],
        dueAt: newRequest['Due At'],
        createdAt: newRequest['Created At'],
        updatedAt: newRequest['Updated At'],
